    ...
    <AuthGuard>
      <main className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto px-6 py-16">
          ...
          {error && <p className="text-destructive font-semibold p-4 bg-destructive/10 border border-destructive/20 rounded-md">{error}</p>}
                    ...
                    <div className="flex items-center gap-4 flex-grow">
                      {thumbnailUrl ? (
                        <div className="relative w-24 h-16 rounded-md overflow-hidden bg-muted">
                          ...
                          />
                          <div className="hidden w-full h-full flex items-center justify-center text-xs text-muted-foreground bg-muted absolute inset-0">
                            Failed to Load
                          </div>
                        </div>
                      ) : (
                        <div className="w-24 h-16 rounded-md bg-muted flex items-center justify-center text-xs text-muted-foreground">
                          No Image
                        </div>
                      )}
                      <div>
